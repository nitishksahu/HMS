...
<title>Cash Payment Portal</title>
<style type="text/css">
<%@ include file="css/style.css" %>
</style>
</head>
<body id="body">
<script type="text/javascript" src="javascript/validatecashPayment.js"></script>
...
%>
<form name="finalPayment" action="/HMS3/Controller" method="post"onSubmit="return checkdcashPayment()">
